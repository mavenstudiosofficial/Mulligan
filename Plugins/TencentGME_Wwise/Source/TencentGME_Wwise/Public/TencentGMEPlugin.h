...
* @param[in] recvList The blocklist/allowlist(depends on the routing type) array for receiving voice from other playes
*	The users in the list should be separated by comma in the array. For example "userID_1,userID_2,...,userID_k"
...
* @param[out] recvListBuf The blocklist/allowlist(depends on the routing type) buffer for receiving voice from other playes
